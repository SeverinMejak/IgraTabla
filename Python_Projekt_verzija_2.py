...
class Tabla():
    def __init__(self, master):
        ...
        self.canvas = Canvas(master, width=100*(VELIKOST+1), height=100*(VELIKOST +1))
        ...
        for i in range(VELIKOST+1):
            self.canvas.create_line(50, i*100 + 50,(VELIKOST*100)+50,i*100 +50)
            self.canvas.create_line(i*100 +50, 50 , i*100 +50, (VELIKOST*100) +50)
